...
function () {
  ...
  */
  ...
  AgmDataLayer.ctorParameters = function () {
    return [{
      type: _dataLayerManager.DataLayerManager
    }];
  };
...
if (false) {
  /** @type {?} */
  AgmDataLayer._dataOptionsAttributes;
  /** @type {?} */

  AgmDataLayer.prototype._addedToManager;
  /** @type {?} */

  AgmDataLayer.prototype._id;
  /** @type {?} */

  AgmDataLayer.prototype._subscriptions;
  /**
   * This event is fired when a feature in the layer is clicked.
   * @type {?}
   */

  AgmDataLayer.prototype.layerClick;
  /**
   * The geoJson to be displayed
   * @type {?}
   */

  AgmDataLayer.prototype.geoJson;
  /**
   * The layer's style function.
   * @type {?}
   */

  AgmDataLayer.prototype.style;
  /** @type {?} */

  AgmDataLayer.prototype._manager;
}